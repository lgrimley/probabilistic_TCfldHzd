...
os.chdir(r'Z:\Data-Expansion\users\lelise\projects\Carolinas_SFINCS\Chapter3_SyntheticTCs\04_RESULTS\NCEP')

files = []
for f in os.listdir(os.getcwd()):
    if "zsmax_classified" in f:
        files.append(f)
...
mask = xr.open_dataarray(r'../basin_mask.nc')
...
for f in files:
    da = xr.open_dataarray(f, engine='netcdf4')
...
fld_area_df.round(5).to_csv('overland_flooded_area_table.csv')
