...
track_file = os.path.join(track_dir, f'UScoast6_AL_canesm_ssp585cal_roEst1rmEst1_trk100')
tc_tracks = sio.loadmat(f'{track_file}.mat')

# Read in the ADCIRC modeled peaks and get the TC ids
gage_peaks = pd.read_csv('.\stormTide\gage_peaks_canesm_ssp585.csv', index_col=0)
