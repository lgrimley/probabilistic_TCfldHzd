...
proj_group = futdf.groupby('AOI')[['Compound','Coastal', 'Runoff','Total_Flooded']].describe(percentiles=[0.05, 0.1, 0.25, 0.50, 0.75, 0.90, 0.95])
...
abcd.to_csv(r'Z:\Data-Expansion\users\lelise\projects\Carolinas_SFINCS\Chapter3_SyntheticTCs\04_RESULTS\flood_area_standardDev.csv')
...
combined_stats.to_csv(r'Z:\Data-Expansion\users\lelise\projects\Carolinas_SFINCS\Chapter3_SyntheticTCs\04_RESULTS\flood_extent_stats.csv')
...
if violin_plot is True:
    ...
    for i in range(len(scenarios)):
        ...
        df_combined = pd.concat([histdf[['tc_id', 'AOI', scenario, 'Period']], futdf[['tc_id', 'AOI', scenario, 'Period']]])
