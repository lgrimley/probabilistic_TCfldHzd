...
os.chdir(wdir)
zsmax_file = f'zsmax_{x}.nc'
attr_file = f'attribution_{x}.nc'
zsmax_filepath = fr'{wdir}/canesm_ssp585/zsmax/zsmax_{x}.nc'
attr_filepath = fr'{wdir}/canesm_ssp585/attribution/attribution_{x}.nc'
res = 20
hmin = 0.05
proj_crs = 32617

output_filename = zsmax_file.replace('.nc', f'_sbg{res}m_hmin{hmin}.csv')
output_filepath = fr'{wdir}/canesm_ssp585/{output_filename}'
