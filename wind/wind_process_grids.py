...
''' DATA to netcdf '''
os.chdir(r'Z:\Data-Expansion\users\lelise\Chapter3\NCEP_Reanalysis\wind')
input_dir = os.path.join(os.getcwd(), '01_CLE15_WindOutput')
output_dir = os.path.join(os.getcwd(), '02_CLE15_WindOutput_Gridded')
