%ER11E04_nondim_rmaxinput.m -- Chavas et al. 2015 profile merging ER11 and E04 solutions
%Purpose: Merge E04 and ER11 profiles for input rmax
%
% Syntax:
...
function [rr,VV,r0,rmerge,Vmerge,rrfracr0,MMfracM0,rmaxr0,MmM0,rmerger0,MmergeM0] = ...
    ER11E04_nondim_rmaxinput(Vmax,rmax,fcor,Cdvary,C_d,w_cool,CkCdvary,CkCd,eye_adj,alpha_eye)
...
while(abs(drmaxr0)>=drmaxr0_thresh)  %keep looping til changes in estimate are very small
    ...
    if(numel(X0)==0)    %no intersections -- r0 too large --> rmaxr0 too small
